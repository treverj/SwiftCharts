...
class ScrollExample: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let yValues = ChartAxisValuesStaticGenerator.generateYAxisValuesWithChartPoints(chartPoints: chartPoints0, minSegmentCount: 10, maxSegmentCount: 20, multiple: 2, axisValueGenerator: {ChartAxisValueDouble($0, labelSettings: labelSettings)}, addPaddingSegmentIfEdge: false)
        ...
        DispatchQueue.global(priority: DispatchQueue.GlobalQueuePriority.default).async {
            ...
            DispatchQueue.main.async {
                ...
                let lineModel1 = ChartLineModel(chartPoints: chartPoints1, lineColor: UIColor.blue, animDuration: 1, animDelay: 0)
