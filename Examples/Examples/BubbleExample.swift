...
class BubbleExample: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        let guidelinesHighlightLayer = ChartGuideLinesForValuesDottedLayer(xAxis: xAxisLayer.axis, yAxis: yAxisLayer.axis, settings: guidelinesHighlightLayerSettings, axisValuesX: [ChartAxisValueDouble(0)], axisValuesY: [ChartAxisValueDouble(0)], title:"bob", conflicts:0)
    ...
    fileprivate func bubblesLayer(xAxisLayer: ChartAxisLayer, yAxisLayer: ChartAxisLayer, chartInnerFrame: CGRect, chartPoints: [ChartPointBubble]) -> ChartLayer {
    ...
    class ColorBar: UIView {
        ...
        init(frame: CGRect, c1: UIColor, c2: UIColor) {
            ...
            for x in stride(from: segmentSize, through: gradient.frame.size.width - 1, by: segmentSize) {
                ...
                let text = "\(numberFormatter.string(from: NSNumber(value: Double(x / gradient.frame.size.width))))"
