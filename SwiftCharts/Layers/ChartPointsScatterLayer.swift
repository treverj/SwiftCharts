...
open class ChartPointsScatterLayer<T: ChartPoint>: ChartPointsLayer<T> {
    ...
    open func drawChartPointModel(context: CGContext, chartPointModel: ChartPointLayerModel<T>, view: UIView) {
        fatalError("override")
    }
    ...
    func generateCGLayer(context: CGContext, view: UIView, contentScale: CGFloat) -> CGLayer? {
...
open class ChartPointsScatterTrianglesLayer<T: ChartPoint>: ChartPointsScatterLayer<T> {
    ...
    override func generateCGLayer(context: CGContext, view: UIView, contentScale: CGFloat) -> CGLayer? {
    ...
    override open func drawChartPointModel(context: CGContext, chartPointModel: ChartPointLayerModel<T>, view: UIView) {
